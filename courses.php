...
try {
    ...
    $stmt = $conn->prepare("SELECT id, title, image, rating, created_at FROM courses ORDER BY created_at DESC LIMIT :limit OFFSET :offset");
    ...
    $total_courses = $totalStmt->fetchColumn();
...
<head>
    ...
    <title>Courses - Content Learning Hub</title>
    ...
    <section class="content">
            ...
            <?php if (!empty($courses)): ?>
                ...
                <?php foreach ($courses as $course): ?>
                    <div class="post" style="--index: <?php echo $index++; ?>;">
                        ...
                        <a href="course.php?id=<?php echo $course['id']; ?>" class="btn">Enroll Now</a>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
        ...
        <div class="pagination">
            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                <a href="courses.php?page=<?php echo $i; ?>" class="btn <?php echo $page == $i ? 'active' : ''; ?>">
                    <?php echo $i; ?>
                </a>
            <?php endfor; ?>
            <?php if ($page < $total_pages): ?>
                <a href="courses.php?page=<?php echo $page + 1; ?>" class="btn">Next</a>
            <?php endif; ?>
        </div>
    </section>
