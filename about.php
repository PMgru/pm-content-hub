...
<head>
    ...
    <title>About Us - Content Learning Hub</title>
...
<body>
    ...
    <section class="about">
        <h2>About Us</h2>
        <p>Welcome to Content Learning Hub! We are dedicated to providing high-quality content and courses to help you master digital marketing, SEO, content writing, and more.</p>
        <p>Our mission is to empower individuals and businesses with the knowledge and skills they need to succeed in the digital world. Our expert-led courses and resources are designed to be practical, engaging, and accessible to everyone.</p>
        <h3>Our Team</h3>
        <div class="team-list">
